package com.gcoea_note;

public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://lunarblade99.github.io/GCOEA/";
    public static String WEBAPP_HOST = "lunarblade99.github.io/GCOEA"; // used for checking Intent-URLs
